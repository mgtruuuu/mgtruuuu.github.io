...
int main() {
    ...
    // The Fraction(int, int) constructor will be used to construct a new Fraction from 2,
    // This new Fraction is then multiplied by f2 using the Fraction * Fraction operator.
    Fraction f5{ 2 * f2 };
    f5.print();
