...
int main() {
    ...
    // use member selection operator to select a member of the struct
    today.day = 16; 
    print(today);
    // "2020/10/16"
}
...
// unless the compiler has already seen a forward declaration for y()
}
