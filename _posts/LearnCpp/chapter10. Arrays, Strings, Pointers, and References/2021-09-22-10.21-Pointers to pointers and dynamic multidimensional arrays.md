...
```c++
// Note : It can be defined
// when all dimensions except the leftmost are compile-time constants.
...
// Note : It can be defined
// when the rightmost array dimension is a compile-time constant.
