...
- **Value containers** are [compositions](https://www.learncpp.com/cpp-tutorial/composition/) that store *copies of the objects that they are holding* (and thus are responsible for creating and destroying those copies).
- **Reference containers** are [aggregations](https://www.learncpp.com/cpp-tutorial/103-aggregation/) that store *pointers or references to other objects* (and thus are not responsible for creation or destruction of those objects).
