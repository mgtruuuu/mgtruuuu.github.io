...
```c++
// note: no variable name 
// since we don't use it in the catch block below.
catch (double) {
...
int main() {
    ...
    // Handle exception of type double.
        ...
        std::cerr << "We caught a double of value: "
            << x << '\n';
    }
}
```
