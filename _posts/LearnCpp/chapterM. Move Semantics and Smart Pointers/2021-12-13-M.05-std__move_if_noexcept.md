...
// Take in an 'old' pair, and then move construct
// the new pair's 'first' and 'second' subobjects from the 'old' ones.
...
public:
    ...
    // when copying from a CopyClass object where its m_throw is 'true'.
