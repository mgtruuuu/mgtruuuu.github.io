...
Now let's use two classes, `MoveClass` and `CopyClass`, which we will pair together to demonstrate the strong exception guarantee problem with move constructors:
