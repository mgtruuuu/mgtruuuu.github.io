...
int main() {
    ...
    // Also note that the Resource in angled braces doesn't need a * symbol,
...
public:
    ...
    Auto_ptr2& operator=(Auto_ptr2& a) {
        ...
        // Then transfer our dumb pointer from the source to the local object.
        m_ptr = a.m_ptr;
